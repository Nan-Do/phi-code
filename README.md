...
The **$\varphi$-Code** agentic system achieved a significant milestone by successfully answering **all** questions for the latest LeetCode's [Weekly Contest 476](https://leetcode.com/contest/weekly-contest-476/) (as of the publication date on 11-17-2025) **correctly on the first attempt!**
...
Using the underlying [gpt-oss-20B at Q4](https://huggingface.co/unsloth/gpt-oss-20b-GGUF) model, $\varphi$-Code's successful execution achieved a final contest score of **18**, tying the Python score obtained by much larger models like [Gemini 2.5 Pro](https://gemini.google.com/), [GPT-5](https://chatgpt.com/), [DeepSeek v3.2](https://www.deepseek.com/), [Qwen 3](https://github.com/QwenLM/Qwen3), and [Grok 4](https://grok.com/) in the competition.
