...
Using the underlying [gpt-oss-20B at Q4](https://huggingface.co/unsloth/gpt-oss-20b-GGUF) model, $\varphi$-Code's successful execution achieved a final contest score of **18**, tying the Python score obtained by much larger models like [Gemini 2.5 Pro](https://gemini.google.com/), [GPT-5](https://chatgpt.com/), [DeepSeek v3.2](https://www.deepseek.com/), [Qwen 3](https://github.com/QwenLM/Qwen3), or [Grok 4](https://grok.com/), and surpassing many others like [Claude (Sonnet 4.5 | Opus 4.1)](https://claude.ai/), [GLM 4.6](https://chat.z.ai/), [Doubao 1.5 Pro](https://www.doubao.com/chat/), or [DeepSeek V3.2 (non-reasoning)](https://www.deepseek.com/)) in the competition.
