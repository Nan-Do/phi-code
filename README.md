# 💡 $\varphi$-Code: An Agentic Python Competitive Programmer Fueled by (tiny) LLMs
...
Using the underlying [gpt-oss-20B](https://huggingface.co/unsloth/gpt-oss-20b-GGUF) (Q4) model, $\varphi$-Code's successful execution achieved a final contest score of **18**, tying the Python score obtained by much larger models like [Gemini 2.5 Pro](https://gemini.google.com/), [GPT-5](https://chatgpt.com/), [DeepSeek v3.2](https://www.deepseek.com/), [Qwen 3](https://github.com/QwenLM/Qwen3), or [Grok 4](https://grok.com/), and surpassing many others like [Claude (Sonnet 4.5 | Opus 4.1)](https://claude.ai/), [GLM 4.6](https://chat.z.ai/), [Doubao 1.5 Pro](https://www.doubao.com/chat/), or [DeepSeek V3.2 (non-reasoning)](https://www.deepseek.com/)) in the competition.

You can check the outputs generated by $\varphi$-Code [here](https://github.com/Nan-Do/phi-code/tree/main/contests_results/leetcode_weekly_476/gpt_oss_20B) and view the official LeetCode contest rankings for the LLMs [here](https://leetcode.com/contest/weekly-contest-476/ranking/?region=llm).
...
* A running **LLaMA server** (e.g., using [`llama.cpp`](https://github.com/ggml-org/llama.cpp)'s `llama-server` tool) hosting an LLM.
  * **Recommended Model:** [**gpt-oss-20B**](https://huggingface.co/openai/gpt-oss-20b) or similar code-centric, compact model.
...
| `-m`, `--site` | From which site are the problem statements (leetcode, atcoder)| `leetcode` |
